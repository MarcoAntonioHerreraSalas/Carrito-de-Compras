...
class App extends Component{
  ...
  state = {
    productos:[
      ...
      {name: 'Arbejas',price: '700',img: '/productos/arbejas.jpg'},
    ],
  ...
  render(){
    const esCarroVisible = this.state.esCarroVisible;
    return(
      <div>
        <Navbar esCarroVisible = {esCarroVisible} mostrarCarro={this.mostrarCarro} carro = {this.state.carro}></Navbar>
        <Layout>
          <Title></Title>
